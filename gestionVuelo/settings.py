...
ROOT_URLCONF = 'gestionVuelo.urls'
...
WSGI_APPLICATION = 'gestionVuelo.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / "db.sqlite3",  # se crea el archivo db.sqlite3 en la raíz del proyecto
    }
}
